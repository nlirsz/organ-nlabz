...
```tool_code
// Adding loading state and visual feedback to the add product tab component.
import { useState } from "react";
import { useQueryClient } from "@tanstack/react-query";
import { useMutation } from "@tanstack/react-query";
import { Link, Plus, Wand2, Edit, Star, ExternalLink, Package, ShoppingCart, Image, Tag, FileText } from "lucide-react";
import { useToast } from "@/hooks/use-toast";
